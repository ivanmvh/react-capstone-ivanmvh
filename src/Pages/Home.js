...
const Home = () => {
  const categories = [
    { categoryCode: 'backgrounds', categoryName: 'backgrounds' },
    { categoryCode: 'fashion', categoryName: 'fashion' },
    { categoryCode: 'nature', categoryName: 'nature' },
    { categoryCode: 'science', categoryName: 'science' },
    { categoryCode: 'education', categoryName: 'education' },
    { categoryCode: 'feelings', categoryName: 'feelings' },
  ];
      ...
      <div id="categoryGrid">
        {categories.map((category) => (
          <div className="categoryContainer" key={category.categoryCode}>
            <NavLink to="./category" className="categoryLink" key={category.categoryCode} id={category.categoryCode}>
